                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <a href="{{ url("user_detail") ."/". $user->id . "/edit" }}" title="Edit user_detail"><button class="btn btn-primary btn-xs">Edit</button></a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-borderless">
                                    <tbody>
										...
										<tr><th>photo</th><td>{{$user->user_detail->photo}} </td></tr>
										<tr><th>birthday</th><td>{{$user->user_detail->birthday}} </td></tr>
